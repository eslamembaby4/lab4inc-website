      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="group relative inline-flex items-center justify-center px-10 py-5 bg-emerald-900 text-white overflow-hidden shadow-xl transition-all duration-300 hover:shadow-2xl rounded-lg"
          >
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center justify-center px-10 py-5 border-2 border-emerald-900 text-emerald-900 hover:bg-emerald-900 hover:text-white transition-all duration-300 text-lg font-medium rounded-lg"
          >
            Explore Services
          </motion.a>
        </motion.div>
