        ...
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-6 py-2.5 bg-emerald-900 text-white hover:bg-emerald-800 transition-colors font-medium shadow-lg hover:shadow-xl"
            >
              Contact
            </motion.a>
          </nav>
          ...
          >
            <nav className="flex flex-col px-4 py-4 space-y-3">
              ...
              <a
                href="#contact"
                onClick={() => setMobileMenuOpen(false)}
                className="text-center px-6 py-2.5 bg-emerald-900 text-white hover:bg-emerald-800 transition-colors font-medium"
              >
                Contact
              </a>
            </nav>
