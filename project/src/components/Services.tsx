          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="group relative p-8 border-l-4 border-emerald-900/20 hover:border-emerald-900 bg-slate-50/50 hover:bg-white transition-all duration-300 hover:shadow-2xl"
              >
                <div className="flex items-start gap-6">
                  <div className="flex flex-col items-center gap-3">
                    <motion.div
                      whileHover={{ scale: 1.1, rotate: 5 }}
                      className="p-3 bg-emerald-900/10 group-hover:bg-emerald-900 transition-colors duration-300"
                    >
