...
export default function ContactSection() {
  ...
  const inputClasses = (fieldName: string) => `
    w-full px-4 py-3 border-2 transition-all duration-200 focus:outline-none focus:ring-2
    ...
    <section id="contact" className="py-32 px-4 bg-gradient-to-b from-slate-50 to-white">
      <div className="max-w-5xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-white p-8 md:p-12 shadow-xl border border-slate-200 mb-12"
        >
          {submitStatus === 'success' && (
            <motion.div
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
              className="mb-6 p-4 bg-emerald-50 border-2 border-emerald-500 flex items-start gap-3"
            >
          ...
          {submitStatus === 'error' && (
            <motion.div
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
              className="mb-6 p-4 bg-red-50 border-2 border-red-500 flex items-start gap-3"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <motion.button
              ...
              className="w-full px-10 py-4 bg-emerald-900 text-white hover:bg-emerald-800 transition-colors font-medium text-lg shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <>
                  <motion.div
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <motion.div
            ...
            whileHover={{ y: -5 }}
            className="group relative bg-white p-10 border-2 border-slate-100 hover:border-emerald-500/30 transition-all duration-300 hover:shadow-xl"
          >
            <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-emerald-600 to-teal-600 transform scale-y-0 group-hover:scale-y-100 transition-transform duration-300 origin-top"></div>
